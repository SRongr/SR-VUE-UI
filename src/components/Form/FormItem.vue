<template>
  <div class="sr-form-item">
    <label class="sr-form-item-label" :style="labelStyle"><span v-if="isRequired" class="sr-form-item-label-require">*</span><slot name="label">{{ label }} :</slot></label>
    <div class="sr-form-item-content">
      <slot></slot>
      <transition name="fade">
        <span class="item-error" v-if="validateMessage">{{ validateMessage }}</span>
      </transition>
    </div>
  </div>
</template>
